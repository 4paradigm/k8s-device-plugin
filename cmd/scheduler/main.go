...
func init() {
	...
	rootCmd.Flags().Float32Var(&config.TotalCoreNodeWeight, "total_core_node_weight", 1, "total core node weight: 0-100")
	rootCmd.Flags().Float32Var(&config.CountNodeWeight, "count_node_weight", 1, "count node weight: 0-100")
	rootCmd.Flags().Float32Var(&config.NodePodantiaffinityWeight, "node_podantiaffinity_weight", 1, "node podantiaffinity weight: 0-100")
